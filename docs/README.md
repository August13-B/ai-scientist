...
| [database.md](database.md) | 数据库设计（预留占位，由后端组确定表结构） | 后端组 |
| [roadmap.md](roadmap.md) | 六周 Sprint 计划与里程碑 | 队长 |
| [contribution.md](contribution.md) | 开发规范：分支策略、提交规范、代码规范 | 全体成员 |

> 约定：本目录中标注「**由团队确定**」的内容为开发细节，设计时由对应小组补充，避免过早固化。
